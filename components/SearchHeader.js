...
export default function SearchHeader() {
  ...
  return (
    <header className="sticky top-0 bg-white ">
        <div className="flex w-full p-6 bg-white items-center">
            <img 
              onClick={()=>router.push("/")}
               width="120"
               height="40"
              ...
              />            
            <form className="flex border border-gray-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow max-3-3xl items-center">
                <input className="w-full focus:outline-none pl-5" type="text" defaultValue={router.query.term} ref={searchInputRef}/>
                ...
                <SearchIcon className="h-6 mr-5 ml-3  hidden sm:inline-flex text-blue-500"/>
